...
\lstdefinelanguage{Isabelle}{
  ...
  keywords=[1]{definition, if, then, else, let, in, case, of, do, SOME, lemma, note},
...
\begin{lstlisting}[language=Isabelle]
lemma estimate_decrease: estimate ${\color{isa_dark_blue}\mathcal{A}}$ (P', L') $\leq$ estimate ${\color{isa_dark_blue}\mathcal{A}}$ (P, L)
\end{lstlisting}
...
\begin{lstlisting}[language=Isabelle]
$\sum$s$\leftarrow$zs. card(preds ${\color{isa_dark_blue}\mathcal{A}}$ (fst s) (snd s)) * log(card(snd s)) $\leq$
$\sum$s$\leftarrow$zs'. card(preds ${\color{isa_dark_blue}\mathcal{A}}$ (fst s) (snd s)) * log(card(snd s))
\end{lstlisting}
...
\begin{lstlisting}[language=Isabelle]
note unique_split=
$\isafixed{B}$ $\in$ set $\isafixed{zs}$ $\Longrightarrow$ $\exists$!($\isavar{B1}$, $\isavar{B2}$). $\isavar{B1}$ $\in$ set $\isafixed{zs'}$ $\land$ $\isavar{B2}$ $\in$ set $\isafixed{zs'}$ $\land$
...
$\isafixed{B1}$ $\in$ set $\isafixed{zs'}$ $\Longrightarrow$ $\exists$!($\isavar{B}$, $\isavar{B2}$). $\isafixed{B1}$ $\in$ set $\isafixed{zs}$ $\land$ $\isavar{B2}$ $\in$ set $\isafixed{zs'}$ $\land$
